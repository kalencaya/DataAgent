 ...
 */
@Component
public class MaxComputeDatasourceTypeHandler implements DatasourceTypeHandler {

	@Override
	public String typeName() {
		return BizDataSourceTypeEnum.MAX_COMPUTE.getTypeName();
	}
	...
	public String buildConnectionUrl(Datasource datasource) {
		...
		return String.format("jdbc:odps:http://%s?project=%s", datasource.getHost(),
